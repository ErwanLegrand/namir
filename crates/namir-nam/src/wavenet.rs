...
/// consume it, so refusing with a message that names the value is the honest answer rather than
/// silently ignoring a field whose presence suggests the exporter meant something by it.
