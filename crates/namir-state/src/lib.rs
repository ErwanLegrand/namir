...
//! - FR-STATE-040 — the JSON format itself: pretty-printed, sorted, and, via
//!   [`reference::RelPath`], free of platform-specific path syntax in what it stores; plus, since
//!   M15, the **schema check** the second half of that requirement's compound `*Verify:*` method
//!   names — [`schema`], a validator for §§3–7 of `docs/04-state-and-preset-format.md` written
//!   independently of this crate's own reader (issue #27).
