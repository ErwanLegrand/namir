...
pub const DIR_UNREADABLE: ErrorCode = ErrorCode::new(
    ...
    Severity::Warning,
    "The directory {path} could not be read and was skipped.",
);
...
pub const FILE_UNREADABLE: ErrorCode = ErrorCode::new(
    ...
    Severity::Warning,
    "The file {path} could not be read and was skipped.",
);
...
pub const FILE_TOO_LARGE: ErrorCode = ErrorCode::new(
    ...
    Severity::Warning,
    "The file {path} is larger than the {limit_mb} MB limit and was indexed \
...
pub const INDEX_CORRUPT: ErrorCode = ErrorCode::new(
    ...
    Severity::Warning,
    "The library index at {path} could not be read ({detail}) and will be \
...
pub const NON_UTF8_PATH: ErrorCode = ErrorCode::new(
    ...
    Severity::Warning,
    "A path under {parent} is not valid UTF-8 and was skipped.",
);
