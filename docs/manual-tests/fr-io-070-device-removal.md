...
`StreamFailure::DeviceLost` (`crates/namir-app/src/audio_io.rs:542`). **This unplug did not produce
...
(`crates/namir-app/src/app.rs:221`), and there is no device-selection surface anywhere in
