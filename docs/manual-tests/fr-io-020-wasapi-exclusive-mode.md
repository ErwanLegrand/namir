...
source annotation resolves it, and `xtask/src/traceability.rs:617-642` refuses a
...
`namir-app` restricts shared mode to `F32` (`crates/namir-app/src/audio_io.rs:469`), so what this
