...
|---|---|---|---|
| per-residue-minimum estimator | 14.40% of one core | **29.07%** | 2.02x |
| raw `p99.9` | 16.76% | **31.39%** | 1.87x |
| `p99` | 14.83% | 29.96% | 2.02x |
| `p50` | 7.40% | 15.07% | 2.04x |
