...
- [ ] The rest of the gate block in `README.md` (every *other* `xtask` subcommand + `cargo deny
      check`), which `xtask ci-commands` keeps in step with `.github/workflows/ci.yml` both ways
